...
namespace Tasks.DataLayer {
    ...
    public partial class UsersDS : global::System.Data.DataSet {
        ...
        public partial class UserRolesDataTable : global::System.Data.TypedTableBase<UserRolesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UserRolesRow AddUserRolesRow(string UserName, string RoleName) {
            ...
            public string RoleName {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'RoleName\' в таблице \'UserRoles\' равно DBNull.", e);
                    }
                }
                set {
...
namespace Tasks.DataLayer.UsersDSTableAdapters {
    ...
    public partial class UserRolesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        AspNetUsers.UserName, AspNetRoles.Name AS RoleName
FROM            AspNetUsers LEFT JOIN
        ...
        public virtual int Fill(UsersDS.UserRolesDataTable dataTable) {
        ...
        public virtual UsersDS.UserRolesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UsersDS.UserRolesDataTable dataTable = new UsersDS.UserRolesDataTable();
